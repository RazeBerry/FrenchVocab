...
FRENCH_CONFIG = LanguageConfig(
    ...
    anki=AnkiConfig(
        ...
        guid_headword_aliases={
            "alambic (m.)": "alambique (m.)",
            "ânerie": "anerie",
            "assommant": "assomant",
            "à double tranchant": "double tranchant",
            "bras ballants": "bras ballants:",
            "dépourvu": "depourvu",
            "désobligeante": "desobligeante",
            "enjôler": "enjoler",
            "étroitesse": "etroitesse",
            "grésillement": "gresillement",
            "paillage": "paillaison",
            "palpitant": "paipitant",
            "prendre soin de quelque chose": "prends soins de qqch",
            "protéiforme": "proteiforme",
            "rédhibitoire": "redhibitoire",
            "saignée": "saignee",
            "scolopendre (f.)": "scolopendre (m.)",
        },
    ),
