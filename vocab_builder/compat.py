...
_ENV_ALIASES: dict[str, tuple[str, ...]] = {
    ...
    "VOCABBUILDER_CLAUDE_MODEL": ("FRENCHVOCAB_CLAUDE_MODEL", "FRENCH_VOCAB_CLAUDE_MODEL"),
    "VOCABBUILDER_GEMINI_MODEL": ("FRENCHVOCAB_GEMINI_MODEL", "FRENCH_VOCAB_GEMINI_MODEL"),
    "VOCABBUILDER_COMPOSITION": ("FRENCHVOCAB_COMPOSITION", "FRENCH_VOCAB_COMPOSITION"),
    "VOCABBUILDER_COMPOSITION_WORDS": ("FRENCHVOCAB_COMPOSITION_WORDS", "FRENCH_VOCAB_COMPOSITION_WORDS"),
    "VOCABBUILDER_COMPOSITION_SET_SIZE": (
        "FRENCHVOCAB_COMPOSITION_SET_SIZE",
        "FRENCH_VOCAB_COMPOSITION_SET_SIZE",
    ),
